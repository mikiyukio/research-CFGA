...
from SCDA_cars_resnet50.grad_cam import GradCam_yuhan_kernel_version30_DGCRL_scda_many_for_retrivial,\
    ...
    GradCam_yuhan_kernel_version30_DGPCRL_scda_many_4_for_retrieval_1,PoolCam_yuhan_kernel_for_retrieval
import cv2
...
parser.add_argument("--model_name", type=str, dest="model_name", help="The name of the model to be loaded.", default='checkpoint_100_0.9940.pth')
...
# img_name=r'177Rolls-Royce_Phantom_Sedan_2012\014501.jpg'
...
# for phase in ['train','test']:
        for images, labels in loaders[phase]:#一个迭代器，迭代数据集中的每一batch_size图片;迭代的返回值dataset的子类中的__getitem__()方法是如何进行重写的；
                ...
                for flip in range(1):
                        ...
                        grad_cam_scda =GradCam_yuhan_kernel_version30_DGPCRL_scda_many_4_for_retrieval_1(net)
...
kernel_0 = kernel_0.cpu().data.numpy()*255
