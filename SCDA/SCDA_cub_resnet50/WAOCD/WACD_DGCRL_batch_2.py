from SCDA_cub_resnet50.net_res50 import FGIAnet100_metric5_1,FGIAnet100_metric5,FGIAnet100_metric5_2,FGIAnet100_metric5_3
from SCDA_cub_resnet50 import dataloader_test  #DGCRL test
from SCDA_cub_resnet50 import dataloader   #DGCRL DGPCRL train
from SCDA_cub_resnet50 import dataloader_DGPCRL_test   #DGPCRL test
...
from SCDA_cub_resnet50.grad_cam import  GradCam_yuhan_kernel_version30_DGCRL_scda_many_4,\
    ...
    GradCam_yuhan_kernel_version30_DGPCRL_scda_many_4_2,GradCam_yuhan_kernel_version30_DGPCRL_scda_many_4_gai,\
    PoolCam_yuhan_kernel,PoolCam_yuhan_kernel_scda,PoolCam_yuhan_kernel_scda_square_sum,\
    PoolCam_yuhan_kernel_scda_origin,PoolCam_yuhan_kernel_scda_origin_test,\
    PoolCam_yuhan_kernel_scda_origin_2,\
    PoolCam_yuhan_kernel_scda_origin_no_lcc,\
    PoolCam_yuhan_kernel_scda_origin_no_lcc_ablation_study_1,\
    PoolCam_yuhan_kernel_scda_origin_no_lcc_ablation_study_2


parser = argparse.ArgumentParser()
parser.add_argument('--img_size', type=int, default = 700,help='进行特征提取的图片的尺寸的上界所对应的数量级')
# parser.add_argument('--img_size', type=int, default = 288,help='进行特征提取的图片的尺寸的上界所对应的数量级')



# PARA=[
#       # 'checkpoint_90_0.9863.pth',
#       'checkpoint_95_0.9969.pth',
#       'checkpoint_100_1.0.pth',
#       # 'checkpoint_105_0.9988.pth',
#       # 'checkpoint_110_0.9991.pth',
#
# ]

#
# PARA=[
#     # 'checkpoint_19_0.9665.pth',
#     # 'checkpoint_19_0.9681.pth',
#     # 'checkpoint_19_0.9682.pth',
#     # 'checkpoint_19_0.9687.pth',
#     # 'checkpoint_19_0.9689.pth',
#     # 'checkpoint_19_0.9693.pth',
#     # 'checkpoint_19_0.9694.pth',
#     # 'checkpoint_19_0.9701.pth',
#     # 'checkpoint_19_0.9704.pth',
#     # 'checkpoint_20_0.9742.pth',
#     # 'checkpoint_20_0.9745.pth',
#     # 'checkpoint_20_0.9749.pth',
#     # 'checkpoint_20_0.9762.pth',
#     # 'checkpoint_20_0.9773.pth',
#     # 'checkpoint_20_0.9774.pth',
#     # 'checkpoint_20_0.9781.pth',
#     'checkpoint_20_0.9783.pth',
#     'checkpoint_20_0.9785.pth',
#
# ]
...
# PARA=[
#     'checkpoint_95_0.9942.pth',
#     'checkpoint_95_0.9948.pth',
#     'checkpoint_95_0.9950.pth',
#     'checkpoint_95_0.9952.pth',
#     'checkpoint_95_0.9955.pth',
#     'checkpoint_95_0.9957.pth',
#     'checkpoint_95_0.9959.pth',
#     'checkpoint_95_0.9969.pth',
#     'checkpoint_95_0.99480.pth',
...
#     'checkpoint_100_0.99930.pth',
#     'checkpoint_100_0.99940.pth',
#     'checkpoint_100_1.0.pth',
#     'checkpoint_100_1.00.pth',
#     'checkpoint_105_0.9996.pth',
#     'checkpoint_105_0.9998.pth',
#     'checkpoint_105_0.99960.pth',
#     'checkpoint_105_0.99980.pth',
#     'checkpoint_105_1.0.pth',
#     'checkpoint_105_1.00.pth',
#     'checkpoint_105_1.000.pth',
...
for index in range(len(PARA)):
   ...
   # filename=join(os.path.abspath(os.path.dirname(os.getcwd())),'./datafile/layer4_1_conv1_weight.json')#'layer4.1.conv1.weight'
    ...
    # final_features['train']=train_data
    # final_features['test']=test_data
    # # filename=join(os.path.abspath(os.path.dirname(os.getcwd())),'./datafile/layer4_conv2_weight_with_4_2_1.json')##'layer4.1.conv2.weight' + #'layer4.2.conv2.weight'
    # filename=join(target_path,'layer4_conv2_weight_with_4_2_1.json')#'layer4.1.conv3.weight'
    #
    # with open(filename,'w') as f_obj:
    #     json.dump(final_features,f_obj)
    ...
    # final_features['test']=test_data
    # # filename=join(os.path.abspath(os.path.dirname(os.getcwd())),'./datafile/layer4_conv2_weight_with_4_2_1.json')##'layer4.1.conv2.weight' + #'layer4.2.conv2.weight'
    # filename=join(target_path,'DGPCRL_gradient.json')#'layer4.1.conv3.weight'
    #
    # with open(filename,'w') as f_obj:
    #     json.dump(final_features,f_obj)
    ...
    # final_features['test']=test_data
    # # filename=join(os.path.abspath(os.path.dirname(os.getcwd())),'./datafile/layer4_conv2_weight_with_4_2_1.json')##'layer4.1.conv2.weight' + #'layer4.2.conv2.weight'
    # filename=join(target_path,'DGCRL_gradient.json')#'layer4.1.conv3.weight'
    #
    # with open(filename,'w') as f_obj:
    #     json.dump(final_features,f_obj)
