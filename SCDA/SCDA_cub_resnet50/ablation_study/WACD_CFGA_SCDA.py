...
import cv2
from SCDA_cub_resnet50.ablation_study.grad_cam import  PoolCam_yuhan_kernel_embedding,\
    PoolCam_yuhan_kernel_embedding_ablation_1
...
PARA=[
    ...
    # 'checkpoint_2800_8.2089_arc.pth',
    # 'checkpoint_2999_8.4972_arc.pth',
