...
import cv2
from SCDA_cub_resnet50.about_pretraineds.grad_cam import PoolCam_yuhan_kernel_scda_origin_eq5, \
    ...
    # for phase in ['train','test']:
            for images, labels in loaders[phase]:#一个迭代器，迭代数据集中的每一batch_size图片;迭代的返回值dataset的子类中的__getitem__()方法是如何进行重写的；
                    ...
                    for flip in range(1):
                            ...
                            grad_cam_scda = PoolCam_yuhan_kernel_scda_origin_eq5(net)   #有最大连通域
